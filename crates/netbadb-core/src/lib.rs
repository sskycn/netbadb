...
pub use physical_design::{
    ...
    PhysicalColumnarDesignMutationWorkInspection, PhysicalColumnarDesignProposal,
    PhysicalColumnarDesignProposalError, PhysicalColumnarDesignProposalStaleReason,
    PhysicalColumnarMutationPrerequisiteInspection, PhysicalColumnarRecommendationInspection,
    PhysicalDesignAdvisorError, PhysicalDesignAdvisorPolicy, PhysicalDesignAdvisorReport,
    PhysicalDesignCandidateDecision, PhysicalDesignDatabaseIdentity, PhysicalDesignEvidenceEpoch,
    ...
    PhysicalDesignMutationConservativeBound, PhysicalDesignMutationResourceBounds,
    PhysicalDesignMutationWorkInspectionError, PhysicalDesignNoActionReason,
