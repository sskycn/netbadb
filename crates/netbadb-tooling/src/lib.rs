...
impl DiagnosticCode {
    ...
    pub const fn as_str(self) -> &'static str {
        match self {
            ...
            Self::UnsupportedCast => "unsupported_cast",
            Self::CannotInferNullType => "cannot_infer_null_type",
            Self::InvalidLiteral => "invalid_literal",
            Self::CannotInferParameterType => "cannot_infer_parameter_type",
            Self::ParameterTypeConflict => "parameter_type_conflict",
...
const fn hir_code(error: &HirError) -> DiagnosticCode {
    match error {
        ...
        HirError::UnsupportedCast { .. } => DiagnosticCode::UnsupportedCast,
        HirError::CannotInferNullType { .. } => DiagnosticCode::CannotInferNullType,
        HirError::InvalidLiteral { .. } => DiagnosticCode::InvalidLiteral,
        HirError::CannotInferParameterType { .. } => DiagnosticCode::CannotInferParameterType,
        HirError::ParameterTypeConflict { .. } => DiagnosticCode::ParameterTypeConflict,
