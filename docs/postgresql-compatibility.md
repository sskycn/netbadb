...
Use an existing manifest v6 configured for a loopback plaintext address:
...
v1. It does not silently change manifest v6 or open a second port. Only
...
Successful loopback admission maps to manifest v6's `local_plaintext`
